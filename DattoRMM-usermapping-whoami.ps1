# adjusted to fit dattormm from Renada's script: https://documentation.renada.co.uk/books/powershell-scripts/page/ninjarmm-halopsa-improved-user-sync
#matches UDF 20 in DattoRMM
...
$scriptblock = {
    try {
        ...
        Write-Error "Caught an error. Running 'whoami' instead."
        $output = whoami
...
$Result = invoke-ascurrentuser -scriptblock $scriptblock -CaptureOutput

New-ItemProperty -Path 'HKLM:\SOFTWARE\CentraStage' -name Custom28 -value $Result -Force
